...
<div class="wd-products-nav<?php echo esc_attr( $wrapper_classes ); ?>">
	<?php if ( $prev ) : ?>
		<div class="wd-event-hover">
			<a class="wd-product-nav-btn wd-btn-prev" href="<?php echo esc_url( $prev->get_permalink() ); ?>" aria-label="<?php esc_attr_e( 'Previous product', 'woodmart' ); ?>"></a>
	...
	<?php if ( $next ) : ?>
		<div class="wd-event-hover">
			<a class="wd-product-nav-btn wd-btn-next" href="<?php echo esc_url( $next->get_permalink() ); ?>" aria-label="<?php esc_attr_e( 'Next product', 'woodmart' ); ?>"></a>
