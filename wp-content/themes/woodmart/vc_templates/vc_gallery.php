...
?>
	<div class="<?php echo esc_attr( $css_class ); ?>">
		<div class="wpb_wrapper">
			...
			<div class="wpb_gallery_slides<?php echo esc_attr( $type ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-flex_fx="<?php echo esc_attr( $flex_fx ); ?>">
				<?php echo apply_filters( 'wpb_gallery_content', $slides_wrap_start . $gal_images . $slides_wrap_end ); ?>
			</div>
		</div>
	</div>
<?php

if( $type == ' wpb_owl_carousel' ) {
