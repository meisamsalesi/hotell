...
if( ! function_exists( 'woodmart_register_required_plugins' ) ) {
	function woodmart_register_required_plugins() {
	    ...
	    $plugins = array(
			...
			array(
	            'name'               => 'وودمارت فارسی', // The plugin name.
	            'slug'               => 'woodmart-farsi', // The plugin slug (typically the folder name).
	            'source'             => get_parent_theme_file_path( WOODMART_FRAMEWORK . '/plugins/woodmart-farsi.zip' ), // The plugin source.
	            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
