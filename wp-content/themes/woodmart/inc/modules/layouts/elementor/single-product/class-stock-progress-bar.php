 ...
 */
class Stock_Progress_Bar extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_name() {
		return 'wd_single_product_stock_progress_bar';
	}
	...
	public function get_title() {
		return esc_html__( 'Product stock progress bar', 'woodmart' );
	}
	...
	public function get_icon() {
		return 'wd-icon-sp-stock-progress-bar';
	}
