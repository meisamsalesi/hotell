 ...
 */
class Extra_Content extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_name() {
		return 'wd_single_product_extra_content';
	}
	...
	public function get_title() {
		return esc_html__( 'Product extra content', 'woodmart' );
	}
	...
	public function get_icon() {
		return 'wd-icon-sp-extra-content';
	}
	...
	protected function render() {
		...
		echo woodmart_html_block_shortcode( // phpcs:ignore.
			array(
