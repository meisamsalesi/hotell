...
class Navigation extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product navigation', 'woodmart' );
	}
	...
	protected function render() {
		...
		wc_get_template( 'single-product/navigation.php' );
