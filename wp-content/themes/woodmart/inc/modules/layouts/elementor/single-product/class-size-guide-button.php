 ...
 */
class Size_Guide_Button extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_name() {
		return 'wd_single_product_size_guide_button';
	}
	...
	public function get_title() {
		return esc_html__( 'Size guide button', 'woodmart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'         => 'wd_css_class',
				'default'      => 'wd-single-action-btn wd-single-size-guide-btn',
				'prefix_class' => '',
			)
		);
