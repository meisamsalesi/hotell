<?php
/**
 * Category extra description element.
 *
 * @package Woodmart
 */
 ...
 */
class Extra_Description extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_name() {
		return 'wd_shop_archive_extra_description';
	}
	...
	public function get_title() {
		return esc_html__( 'Category extra description', 'woodmart' );
	}
	...
	public function get_icon() {
		return 'wd-icon-sa-category-extra-description';
	}
