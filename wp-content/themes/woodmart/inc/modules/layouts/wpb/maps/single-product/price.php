...
if ( ! function_exists( 'woodmart_get_vc_map_single_product_price' ) ) {
	/**
	 * Price map.
	 */
...
add_filter( 'vc_autocomplete_woodmart_single_product_price_product_id_callback', 'woodmart_productIdAutocompleteSuggester_new', 10, 1 );
add_filter( 'vc_autocomplete_woodmart_single_product_price_product_id_render', 'woodmart_productIdAutocompleteRender', 10, 1 );
