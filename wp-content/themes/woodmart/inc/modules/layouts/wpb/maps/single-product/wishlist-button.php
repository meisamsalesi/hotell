...
if ( ! function_exists( 'woodmart_get_vc_map_single_product_wishlist_button' ) ) {
	/**
	 * Wishlist button map.
	 */
	function woodmart_get_vc_map_single_product_wishlist_button() {
		...
		return array(
			'base'        => 'woodmart_single_product_wishlist_button',
			'name'        => esc_html__( 'Add to wishlist button', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'woodmart' ), 'single_product' ),
			'description' => esc_html__( 'Add the product to wishlist', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/sp-icons/sp-add-to-wishlist-button.svg',
			'params'      => array(
				array(
