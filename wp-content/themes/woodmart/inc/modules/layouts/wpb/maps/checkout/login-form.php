...
if ( ! function_exists( 'woodmart_get_vc_map_checkout_login_form' ) ) {
	/**
	 * Login form map.
	 */
	function woodmart_get_vc_map_checkout_login_form() {
		...
		return array(
			'base'        => 'woodmart_checkout_login_form',
			'name'        => esc_html__( 'Login form', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'Checkout', 'woodmart' ), 'checkout_content' ),
			'description' => esc_html__( 'Checkout user login form', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/ch-icons/ch-login-form.svg',
			'params'      => array(
				array(
