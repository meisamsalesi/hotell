...
if ( ! function_exists( 'woodmart_get_vc_map_single_product_compare_button' ) ) {
	/**
	 * Compare button map.
	 */
		...
		return array(
			...
			'params'      => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-compare-btn > a span' => array(
							'color: {{VALUE}};',
						),
					),
					'dependency'       => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-compare-btn > a:hover span' => array(
							'color: {{VALUE}};',
						),
					),
					'dependency'       => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-compare-btn > a:before' => array(
							'color: {{VALUE}};',
						),
					),
					'edit_field_class' => 'vc_col-sm-6 vc_column',
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-compare-btn > a:hover:before' => array(
							'color: {{VALUE}};',
						),
					),
					'edit_field_class' => 'vc_col-sm-6 vc_column',
