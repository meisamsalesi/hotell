...
class Custom_Fonts extends Field {
	...
	public function render_control() {
		...
		?>
			<div id="<?php echo esc_attr( $this->get_id() ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>" data-key="<?php echo esc_attr( $key ); ?>" class="xts-custom-fonts">
				...
				<div class="xts-custom-fonts-btn-add xts-font-section-add xts-inline-btn xts-color-primary xts-i-add"><?php esc_html_e( 'Add font', 'woodmart' ); ?></div>
	...
	public function section_template( $index, $section_value ) {
		...
		?>
			...
			<div class="xts-font-section xts-group xts-custom-fonts-section<?php echo esc_attr( $hide_class ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>-<?php echo esc_attr( $index ); ?>">
				<h3 class="xts-custom-fonts-title"><?php echo esc_html( $font_name ); ?></h3>
				<div class="xts-row xts-sp-20">
					<div class="xts-custom-fonts-field xts-col-12 xts-col-lg-6">
						...
						<p class="xts-field-description"><?php esc_html_e( 'Enter your name with letters and spacing only. It will be used in a list of fonts under the Typography section. For example: Indie Flower', 'woodmart' ); ?></p>
					</div>
					<div class="xts-custom-fonts-field xts-col-12 xts-col-lg-6">
						<label class="xts-custom-fonts-label">
							<?php esc_html_e( 'Font weight', 'woodmart' ); ?>
						</label>
				...
				<div class="xts-custom-fonts-btn-remove xts-font-section-remove xts-inline-btn xts-color-warning xts-i-trash"><?php esc_html_e( 'Remove', 'woodmart' ); ?></div>
	...
	public function upload_template( $title, $values, $name ) {
		...
		?>
			<div class="xts-custom-fonts-field xts-upload-control xts-col-12 xts-col-lg-6">
				...
				<div class="xts-upload-btns">
					...
					<button class="xts-btn xts-color-warning xts-remove-upload-btn xts-i-trash<?php echo ( isset( $url ) && ! empty( $url ) ) ? ' xts-active' : ''; ?>"><?php esc_html_e( 'Remove', 'woodmart' ); ?></button>
