...
(function ($, window, i) {
    ...
    $.fn.editTable = function (options) {
        ...
        var s = $.extend({
            ...
            defaultth = '<th><a class="addcol xts-bordered-btn xts-color-primary xts-style-icon xts-i-add" title="Add column" href="#"></a> <a class="delcol xts-bordered-btn xts-color-warning xts-style-icon xts-i-trash" title="Remove column" href="#"></a></th>',
            colnumber,
            rownumber,
            reset,
            is_validated = true;
        ...
        function buildRow(data, len) {
            ...
            return $('<tr/>', {
                html: rowcontent + '<td><a class="addrow xts-bordered-btn xts-color-primary xts-style-icon xts-i-add" title="Add row" href="#">+</a> <a class="delrow xts-bordered-btn xts-color-warning xts-style-icon xts-i-trash" title="Remove row" href="#">-</a></td>'
            });
