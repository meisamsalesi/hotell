...
class Image_Hotspot extends Widget_Base {
	...
	protected function render() {
		...
		$image_title = Control_Media::get_image_title( $settings['image'] );
		...
		if ( $image_url ) {
			$image_output = '<img class="wd-image-hotspot-img" src="' . esc_url( $image_url ) . '" alt="' . $image_alt . '" title="' . $image_title . '">';
		}
						...
						<?php if ( 'product' === $settings['hotspot_type'] && isset( $product ) && $product ) : ?>
							<div class="hotspot-product hotspot-content wd-scroll hotspot-dropdown-<?php echo esc_attr( $settings['hotspot_dropdown_side'] ); ?>">
								...
								<div class="hotspot-content-text wd-more-desc set-cont-mb-s reset-last-child<?php echo woodmart_get_old_classes( ' woodmart-more-desc' ); ?>">
									...
									<a href="#" rel="nofollow" class="wd-more-desc-btn<?php echo woodmart_get_old_classes( ' woodmart-more-desc-btn' ); ?>"  aria-label="<?php esc_attr_e( 'Read more description button', 'woodmart' ); ?>"><span></span></a>
								</div>
