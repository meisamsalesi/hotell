<html class="no-js" lang="en">
    <!-- Mirrored from raistheme.com/html/hostgem/hostgem/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Jan 2021 15:45:01 GMT -->
    <head>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="logo">
                        <?php 
                                $meisam = fw_get_db_settings_option('logo_site');
                                ?>
                            <a href="<?php echo site_url(); ?>">
                                 <img src="<?php echo $meisam['url']; ?>" alt="Logo"> 
                            </a>
                        </div>
                    </div>
