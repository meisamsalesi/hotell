...
function meisam(){
	...
	wp_enqueue_style( "style2", get_template_directory_uri() . "/assets/css/animate.min.css");
	wp_enqueue_style( "style3", get_template_directory_uri() . "/assets/css/bootstrap.min.css");
	wp_enqueue_style( "style4", get_template_directory_uri() . "/assets/css/default.css");
	wp_enqueue_style( "style5", get_template_directory_uri() . "/assets/css/fontawesome-all.min.css");
	wp_enqueue_style( "style6", get_template_directory_uri() . "/assets/css/magnific-popup.css");
	wp_enqueue_style( "style7", get_template_directory_uri() . "/assets/css/meanmenu.css");
	wp_enqueue_style( "style8", get_template_directory_uri() . "/assets/css/nice-select.css");
	wp_enqueue_style( "style9", get_template_directory_uri() . "/assets/css/owl.carousel.min.css");
	wp_enqueue_style( "style10", get_template_directory_uri() . "/assets/css/responsive.css");
	wp_enqueue_style( "style11", get_template_directory_uri() . "/assets/css/slick.css");
...
add_action("wp_enqueue_scripts", "meisam" );
...
function theme_support(){
	...
	add_theme_support( 'wp-clock-styles' );
